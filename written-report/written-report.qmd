...
knitr::opts_chunk$set(echo = FALSE, 
                      warning = FALSE, 
                      message = FALSE,
                      fig.width = 8, fig.asp = 0.618, out.width = "70%",
...
$$
\begin{aligned}
\hat{rating} = & 3.210  - .009 \times CocoaPercent + .043 \times NumIngredients \\ & + 0.218 \times isCocoa - 0.134\times isOff - .619 \times isChemical \\ & + .185 \times is Fruit +.233 \times isCreamy + .194 \times isComplex \\ &-.339 \times isBitter - .332 \times Vanilla_{X1} - .207 \times Salt_{X1} \\ 
\end{aligned}
$$
