...
knitr::opts_chunk$set(echo = FALSE, 
                      warning = FALSE, 
                      message = FALSE,
                      fig.width = 10, fig.asp = 0.618, out.width = "70%",
...
$$
\begin{aligned}
\hat{rating} = & 3.216  - .007 \times CocoaPercent + .027 \times NumIngredients \\ & + 0.149 \times isCocoa - 0.232\times isOff - .792 \times isChemical \\ & + .121 \times is Fruit +.361 \times isCreamy + .361 \times isComplex \\ &-.548 \times isBitter - .305 \times Vanilla_{X1} - .122 \times Salt_{X1} \\ 
\end{aligned}
$$
